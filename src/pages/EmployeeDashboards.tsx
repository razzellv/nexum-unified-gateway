...
const GOVT_ROLES = [
  {
    ...
    description: 'Shift assignment, equipment check, incident log, and use-of-force reporting',
  ...
  {
    title: 'Firefighter / EMS',
    description: 'Apparatus checks, SCBA logs, certification tracking, and run reports',
    route: '/dashboard/firefighter',
    icon: Truck,
    color: 'from-orange-500/20 to-orange-600/20',
    borderColor: 'border-orange-500/30',
    iconColor: 'text-orange-500',
  ...
  {
    title: 'Dispatcher',
    description: 'Active calls, unit status board, radio log, and shift handoff notes',
