  ...
  if (!data || data.length === 0) {
    return (
      <div className="flex items-center justify-center h-32 text-muted-foreground">
        <p className="text-sm">No logging activity for the last 7 days</p>
      </div>
    );
  }
          ...
          <div className="flex-1 w-full flex items-end">
            <div 
              className={cn(
                ...
                item.count > 0 
                  ? "bg-gradient-to-t from-green-500 to-green-500/50" 
                  : "bg-muted/20"
              )}
              style={{ 
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex gap-2 mt-1">
                <Badge variant="outline">{user?.name || 'Operator'}</Badge>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Logs Submitted</span>
                  <span className="text-2xl font-bold">{logsThisWeek}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Equipment Checked</span>
                  <span className="text-2xl font-bold text-green-500">{equipmentChecked}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">Time Remaining</span>
                  <span className="text-2xl font-bold text-yellow-500">{shiftHoursRemaining}h</span>
                </div>
                <div className="flex justify-between items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-500">{logsThisWeek}</p>
                </div>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground">Avg Log Time</p>
                  <p className="text-2xl font-bold text-blue-500">3.2m</p>
                </div>
