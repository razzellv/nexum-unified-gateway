import type { RetailCTSInsight } from '@/types/retail';
...
const DIM_COLORS: Record<RetailCTSInsight['dimension'], { text: string; border: string; bg: string }> = {
...
const TrendIcon = ({ trend }: { trend: RetailCTSInsight['trend'] }) => {
...
interface Props {
  insights: RetailCTSInsight[];
  compact?: boolean;
}

export function RetailCTSPanel({ insights, compact = false }: Props) {
    ...
    <Card className="border-[#00FFE1]/20 bg-[#00FFE1]/2">
      <CardHeader className="p-3 pb-2">
        ...
        <p className="text-[11px] text-muted-foreground">
          Store operational performance cross-referenced across reliability, relevance, scalability, volatility, and validation.
          Benchmarked against enterprise retail standards (big-box, grocery, specialty).
        </p>
      </CardHeader>
